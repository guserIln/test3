...
<div class="site-about">
           <div class="col-lg-9">
                <div class="main-title mb32 mt50 d-flex justify-content-between align-items-center">Мои резюме
                    ...
                    <a href="index.php?r=resume%2Fcreate" class="link-orange-btn orange-btn my-vacancies-add-btn">Добавить резюме</a>
                    <a
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="my-resume-dropdown dropdown show mb8">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="index.php?r=resume%2Fupdate&id=<?php echo $value["id"]?>">Редактировать</a>
                                                <a class="dropdown-item" href="index.php?r=resume%2Fdelete&id=<?php echo $value["id"]?>">Удалить</a>
                                            </div>
                                        </div>

                                        <div class="col-xl-12 my-vacancies-block__left-col mb16">
                                            <h2 class="mini-title mb8"><?php 
                                            if ($value["spec"]!=0) {
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-wrap mobile-mb12">
                                                <a class="mr16" href="index.php?r=resume%2Fview&id=<?php echo $value["id"]?>">Открыть</a>
                                            </div>
