...
<div class="main-wrapper">
  <header class="header">
    ...
    <?php
    echo Nav::widget([
        'options' => ['class' => 'navigation-nav nav-item nav-link'],
        'items' => [
            ['label' => 'Резюме', 'url' => ['/site/index'], 'options' => ['class' =>'active']],
            ['label' => 'Мои резюме', 'url' => ['/site/about']],
        ],
    ]);
    ?>
                    ...
                    <ul class="navigation-menu__mobile-nav">
                        <div class="navigation-menu__mobile-nav-top">
                            <li class="navigation-menu__mobile-nav-item active">
                                <a class="nav-link active" href="#">Резюме</a>
                            </li>
        ...
        <div class="container">
            <div class="header-search__wrap">
                <form class="header-search__form">
                    ...
                    <button type="button" class="blue-btn header-search__btn">Найти
                    </button>
                </form>
            </div>
        </div>
